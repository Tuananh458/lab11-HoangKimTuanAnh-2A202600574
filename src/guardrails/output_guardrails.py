    ...
    async def after_model_callback(
        ...
        *,
        ...
        if not filter_result["safe"]:
            ...
            # Update response_text for the next checks
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                # replace llm_response.content with a safe message
                llm_response.content = types.Content(
                    role="model",
                    parts=[types.Part.from_text(text="I cannot provide that information as it violates security policies.")],
                )
