    ...
    async def on_user_message_callback(
        ...
        *,
        ...
        if detect_injection(text):
            ...
            return self._block_response("Request blocked: Security risk (prompt injection detected).")

        # 2. Call topic_filter(text)
        if topic_filter(text):
            self.blocked_count += 1
            return self._block_response("Request blocked: Topic not allowed. Please ask banking questions only.")
